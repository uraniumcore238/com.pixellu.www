...
def setup(request):
    ...
    if browser_name == "chrome":
        ...
        driver = webdriver.Ie(executable_path='../source/chromedriver.exe')
    elif browser_name == "headless":
        print('Starting with headless-chrome')
        options = Options()
...
def _capture_screenshot(name):
    ...
    # allure.attach(self.driver.get_screenshot_as_png(), name=f'error-screenshot+{name}', attachment_type=AttachmentType.PNG)
